...
public class GeoGridSwipe : MonoBehaviour, IPointerDownHandler, IPointerEnterHandler, IPointerUpHandler
{
    public int gridX;
    public int gridY;
    public string letter;

    private GeoWordPlayManager manager;
    ...
    public void Setup(int x, int y, string letterChar, GeoWordPlayManager puzzleMgr)
    {
        gridX = x;
        gridY = y;
        letter = letterChar;
